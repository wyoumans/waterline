...
module.exports = {
  ...
  create: function(values, cb) {
    ...
    async.series([
      ...
      // Automatically add modified and created (if enabled)
      if(self.autoCreated) values.created = new Date();
      if(self.autoModified) values.modified = new Date();
  ...
  update: function(options, newValues, cb) {
    ...
    async.series([
      ...
      // Automatically change modified (if enabled)
      if(self.autoModified) newValues.modified = new Date();
